...
export default function Appointments() {
    ...
    const fetchAppointments = async () => {
        try {
            ...
            const response = await axios.get('https://renteasebackend.onrender.com/appointments');
    ...
    const handleAccept = async (appointmentId) => {
        try {
            ...
            await axios.put(`https://renteasebackend.onrender.com/appointments/${appointmentId}`, { status: 'Accepted' });
    ...
    const handleDelay = async (appointmentId, delayReason, postponeDate, postponeTime) => {
        try {
            ...
            await axios.put(`https://renteasebackend.onrender.com/appointments/${appointmentId}`, {
                status: 'Delayed',
                delayReason,
                postponeDate,
                postponeTime
