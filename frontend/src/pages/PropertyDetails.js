...
export default function PropertyDetails() {
    ...
    async function handlePayment(total){
        let order = await axios.post('https://renteasebackend.onrender.com/payment/checkout', { amount: (total * 100) });
        order = order.data;
        let key_id = await axios.get('https://renteasebackend.onrender.com/payment/key');
        ...
        const options = {
          ...
          "callback_url": "https://renteasebackend.onrender.com/payment/verification",
          "prefill": {
            "name": tenant.name,
            "email": tenant.email,
    ...
    return (
        <div className="p-10 pt-4">
            <div className="bg-white rounded-md shadow-2xl p-4 pt-1 max-w-7xl ml-52 mr-52">
                ...
                {property.image && (
                    <img src={`https://renteasebackend.onrender.com${property.image}`} alt="Property" className="prop_img object-cover rounded-md mt-4" />
                )}
                ...
                <div className="mt-4 pt-3 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-slate-100 rounded-md shadow-xl shadow-violet-300 p-4">
                        ...
                        <div className="mt-3 flex justify-center">
                            ...
                            <button className="bg-purple-500 text-white w-24 px-4 py-2 rounded hover:bg-purple-600 hover:text-green-950" onClick={()=>{handlePayment(property.price)}}>
                                Payment
                            </button>
                        </div>
                    </div>
