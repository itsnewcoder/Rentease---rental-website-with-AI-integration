...
const AddProperty = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const description = await fetch('https://renteasebackend.onrender.com/description', {
        method: 'POST',
        body: formData,
      });
      ...
      const response = await fetch('https://renteasebackend.onrender.com/properties/add', {
        method: 'POST',
        body: formData,
      });
